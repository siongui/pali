...
jstr = """{
  'zh_TW': {
    'canon': {
      ...
      's0201m.mul0.xml': [ { 'source': '3' } ],
      's0201m.mul1.xml': [ { 'source': '3' } ],
      's0201m.mul2.xml': [ { 'source': '3' } ],
      's0201m.mul3.xml': [ { 'source': '3' } ],
      's0201m.mul4.xml': [ { 'source': '3' } ],
      's0202m.mul0.xml': [ { 'source': '3' } ],
      's0202m.mul1.xml': [ { 'source': '3' } ],
      's0202m.mul4.xml': [ { 'source': '3' } ],
      's0402m2.mul6.xml': [ { 'source': '3' } ],
