...
app = webapp2.WSGIApplication([
  ...
  webapp2.Route(r'/<urlLocale:en_US|zh_TW|zh_CN|fr_FR|vi_VN>/', handler=MainPage),
  webapp2.Route(r'/<urlLocale:en_US|zh_TW|zh_CN|fr_FR|vi_VN>/browse/<prefix:.+>/<word:.+>', handler=WordPage),
  webapp2.Route(r'/browse/<prefix:.+>/<word:.+>', handler=WordPage),
  webapp2.Route(r'/<urlLocale:en_US|zh_TW|zh_CN|fr_FR|vi_VN>/browse/<prefix:.+>', handler=PrefixPage),
